        ...
        <Layout title={'starig swagger'}>
            <Container>
                ...
                <List>
                    <ListItem>
                        <Meta>Website</Meta>
                        <WorkLink href={'https://starig.github.io/starig-swagger/'} target="_blank">
                            https://starig.github.io/starig-swagger/ <ExternalLinkIcon mx={'2px'}/>
                        </WorkLink>
                    </ListItem>
                    <ListItem>
                        <Meta>GitHub repository</Meta>
                        <WorkLink href={'https://github.com/starig/starig-swagger'} target="_blank">
                            https://github.com/starig/starig-swagger <ExternalLinkIcon mx={'2px'}/>
                        </WorkLink>
                    </ListItem>
                </List>
